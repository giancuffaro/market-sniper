...
class BaseFuturesSession:
    ...
    def _maybe_auto_close(self):
        # NOTHING TO CLOSE MEANS NOTHING TO DO. This check was missing here
        # while the options side had it: futures went straight to the bracket.
        # So once the position was cleared - by the phantom rule below, by a
        # hand-close, by anything - a bracket still reading "hit" kept sending
        # closes for something that was not there. Found because the phantom
        # test produced 500 identical log lines instead of one.
